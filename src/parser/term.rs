...
// sha3: 634627cb46c6655a9e7b6aafd1fda8ed2738343cf9bd37c00ae1188d9ab8a6
use crate::ast::Term;
...
mod __parse__Term {
    ...
    const __ACTION: &[i8] = &[
        // State 0
        3, 0, 0, 0, 11, 4, 0, 12, 13,
        // State 1
        3, -8, 0, -8, 11, 0, -8, 12, 13,
        // State 2
        3, 0, 0, 0, 11, 4, 0, 12, 13,
        // State 3
        3, 0, 0, 0, 11, 4, 0, 12, 13,
    ...
    {
        // AppTerm = AppTerm, AtomicTerm => ActionFn(5);
    ...
    {
        // Id = r#"[a-zA-Z][a-zA-Z0-9]*"# => ActionFn(10);
        let __sym0 = __pop_Variant0(__symbols);
        let __start = __sym0.0.clone();
        let __end = __sym0.2.clone();
...
#[allow(unused_variables)]
fn __action4<'input>(input: &'input str, (_, __0, _): (usize, Term, usize)) -> Term {
    __0
}
...
#[allow(unused_variables)]
fn __action8<'input>(input: &'input str, (_, __0, _): (usize, String, usize)) -> Term {
    Term::Var(__0).into()
}
...
#[allow(unused_variables)]
fn __action10<'input>(input: &'input str, (_, __0, _): (usize, &'input str, usize)) -> String {
    __0.into()
}
